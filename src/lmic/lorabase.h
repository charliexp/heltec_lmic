...
enum _dr_cn470_t { DR_SF12=0, DR_SF11, DR_SF10, DR_SF9, DR_SF8, DR_SF7, DR_SF7B, DR_FSK, DR_NONE };
enum { DR_DFLTMIN = DR_SF7 };
enum { DR_PAGE = DR_PAGE_CN470 };

// Default frequency plan for CN 470-510MHz ISM band
// Bands:
//  g1 :   1%  14dBm
//  g2 : 0.1%  14dBm
//  g3 :  10%  27dBm
//                 freq             band     datarates
enum { CN470_F1 = 470300000,      // g1   SF7-12
       CN470_F2 = 470500000,      // g1   SF7-12 FSK SF7/250
       CN470_F3 = 470700000,      // g1   SF7-12
       CN470_F4 = 470900000,      // g2   SF7-12
       CN470_F5 = 471100000,      // g2   SF7-12
       CN470_F6 = 471300000,      // g3   SF7-12
       CN470_J4 = 471500000,      // g2   SF7-12  used during join
       CN470_J5 = 471700000,      // g2   SF7-12   ditto
       CN470_J6 = 470100000,      // g2   SF7-12   ditto
};

enum { CN470_FREQ_MIN = 470000000,
       CN470_FREQ_MAX = 510000000 };

enum { CHNL_PING         = 5 };
enum { FREQ_PING         = CN470_F6 };  // default ping freq
enum { DR_PING           = DR_SF9 };       // default ping DR
enum { CHNL_DNW2         = 5 };
enum { FREQ_DNW2         = CN470_F6 };
enum { DR_DNW2           = DR_SF12 };
enum { CHNL_BCN          = 5 };
enum { FREQ_BCN          = CN470_F6 };
enum { DR_BCN            = DR_SF9 };
enum { AIRTIME_BCN       = 144384 };  // micros
